...
import WeatherDetailSidebar from "./WeatherDetailSidebar";
...
function Weather() {
  ...
  return (
    <>
      <button
        type="button"
        className="block rotate-0 cursor-pointer border-0 bg-transparent p-0 text-left transition-transform duration-200 hover:scale-[1.03] focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-[#59C19D]"
        aria-label="打开天气详情"
